...
?>
            <div class="col-lg-4 d-flex">
                <div class="card_car">
                    ...
                    <div class="card-body">
                        <p class="card-text1"><soPrix: <?php echo $user['prix']; ?></p>
                        <p class="card-text1"><sokilométrage: <?php echo $user['kilometrage']; ?></p>
                        <p class="card-text1"><soAnnée: <?php echo $user['annee']; ?></p>
                    </div>
