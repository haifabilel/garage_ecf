            ...
            <div class="card_body">
                <div class="row">
                    ...
                    <div class="col-sm-4 text-center">
                       ...
                       <button type="button" name="add_review" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#reviewButton">Ajouter Avis</button>
                    </div>
                </div>
            </div>
        </div>
...
<!------------------------- Modal -------------------------->
 <div class="modal" id="reviewButton" tabindex="-1" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <h4 class="text-center mt-2 mb-4">
            <i class="fa-regular fa-star" submit_star mr id="submit_star_1" data-rating="1"></i>
            <i class="fa-regular fa-star" submit_star mr id="submit_star_2" data-rating="2"></i>
            <i class="fa-regular fa-star" submit_star mr id="submit_star_3" data-rating="3"></i>
            <i class="fa-regular fa-star" submit_star mr id="submit_star_4" data-rating="4"></i>
            <i class="fa-regular fa-star" submit_star mr id="submit_star_5" data-rating="5"></i>
       </h4>
