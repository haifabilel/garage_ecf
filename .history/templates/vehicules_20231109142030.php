...
if(isset($_POST["action"])) {
    ...
    if(isset($_POST["minimum_price"], $_POST["maximum_price"],$_POST["minimum_kilometrage"], $_POST["maximum_kilometrage"],$_POST["minimum_kilometrage"], $_POST["maximum_kilometrage") && !empty($_POST["minimum_price"]) && !empty($_POST["maximum_price"])) {
