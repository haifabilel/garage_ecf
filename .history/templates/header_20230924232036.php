  ...
  <div class="container col-xxl-8 px-2 py-6">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <button href="./espace_admin/contact.php" type="button" class="btn " data-toggle="modal" data-target="#buttonModal" >Contact  <i class="fa-solid fa-message"></i></button>
        </div>
      </div>
    </div>
  </div>
...
<!-- Modal -->
<div class="modal fade" id="buttonModal" tabindex="-1" role="dialog" aria-labelledby="buttonModal" aria-hidden="true">
