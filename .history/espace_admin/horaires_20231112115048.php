...
if(isset($_POST['Update'])){
    ...
    $query = "INSERT INTO horaires (ouverture_matin ,fermeture_matin, ouverture_apres_midi,fermeture_apres_midi)
    VALUES (:ouverture_matin, :fermeture_matin, :ouverture_apres_midi,:fermeture_apres_midi)";
    ...
    $data = [
        ...
        ':fermeture_apres_midi' => $fermeture_matin,
