    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <h4 class="text-center mt-2 mb-4">
            <i class="fa-regular fa-star" id="submit_star_1" data-rating="1"></i>
            <i class="fa-regular fa-star" id="submit_star_2" data-rating="2"></i>
            <i class="fa-regular fa-star" id="submit_star_3" data-rating="3"></i>
            <i class="fa-regular fa-star" id="submit_star_4" data-rating="4"></i>
            <i class="fa-regular fa-star" id="submit_star_5" data-rating="5"></i>
       </h4>
       <div class="form-group">
        <input type="text" name="user_name" id="user_name" class="form-control" placeholder="Enter your name">
        <textarea name="user_review" id="user_review" class="form-control" placeholder="Enter your name" ></textarea>
    </div>
      </div>
