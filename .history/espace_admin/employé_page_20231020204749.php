...
<tbody>
    ...
    <?php
     ...
     while($user = $req->fetch()){
        ...
        <td><?=$user['datetime']?></td>
        <td>
            <a class="btn btn-primary" href="supprimer_user.php?id=<?=$user['reviewid']?>">Supprimer <i class="fa-regular fa-trash-can"></i></a>
            <a class="btn btn-primary" href="supprimer_user.php?id=<?=$user['id']?>">Approuver <i class="fa-regular fa-trash-can"></i></a>
        </td>
        </tr>
        <?php 
     }
