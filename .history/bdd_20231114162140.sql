...
--CREATE TABLE IF NOT EXISTS `voitures` (`id` int NOT NULL AUTO_INCREMENT,`id_details` int NOT NULL,`brand` varchar(255) NOT NULL,`prix` int NOT NULL, `kilométrage` int NOT NULL,
  `année` int NOT NULL,
