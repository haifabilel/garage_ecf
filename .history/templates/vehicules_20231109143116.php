...
if(isset($_POST["action"])) {
    ...
    && !empty($_POST["minimum_année"]) && !empty($_POST["maximum_année"])) {
        $query = $conn->query("SELECT * FROM voitures WHERE prix BETWEEN '" . $_POST["minimum_price"] . "' AND '" . $_POST["maximum_price"] . "'AND
        kilométrage BETWEEN '" . $_POST["minimum_price"] . "' AND '" . $_POST["maximum_price"] . "'AND prix BETWEEN '" . $_POST["minimum_price"] . "' AND '" . $_POST["maximum_price"] . "'");
    }
