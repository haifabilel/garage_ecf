...
<header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <div class="col-md-3">
      <a href="espace_employé.php"  class="btn btn-primary my-4" id="btn-login" >Back <i class="bi bi-backspace"></i></a>
      <a href="../templates/reviews.php"  class="btn btn-primary my-4" id="btn-login" >Ajouter avis <i class="fa-solid fa-plus" style="color: #ffffff;"></i></a>
    </div>
    </header>
<section>
