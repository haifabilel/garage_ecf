...
?>
            <div class="col-lg-4 d-flex">
                <div class="card_car">
                    ...
                    <div class="card-body">
                        <p class="card-text1"><span class="span">Prix:</span> <?php echo $user['prix']; ?></p>
                        <p class="card-text1"><span class="span">kilométrage:</span> <?php echo $user['kilometrage']; ?></p>
                        <p class="card-text1"><span class="span">Année:</span> <?php echo $user['annee']; ?></p>
                    </div>
