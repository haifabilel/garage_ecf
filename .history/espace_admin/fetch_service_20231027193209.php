...
<tbody>
    ...
    <?php
     ...
     while($user = $req->fetch()){
        ...
        <td>
        <a href="id=<?=$user['id']?>" class="btn btn-primary"><i class="fa-regular fa-pen-to-square" 
        data-bs-toggle="modal" data-bs-target="#ServiceUpdate" style="color: #ffffff;"></i></a><br><br>
  ...
  <form action="" method="POST" enctype="multipart/form-data">
    <div class="modal-content">
      ...
      <div class="form-group">
       ...
       <input type="text" name="titre" class="form-control" value="<?php $user['titre']?>"  placeholder="Titre de service" required><br>
      </div>
      <div class="form-group">
