...
<div class="container_services p-3 ">
    <div class="content_services d-flex">
       ...
       <div class="content_button mt-2">
          ...
          <a href="vehicules.php" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ajoutCar">Ajouter détails <i class="fa-solid fa-circle-plus" style="color: #ffffff;"></i></a>
       </div>
    </div>
<section>
