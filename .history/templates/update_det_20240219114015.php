...
if(isset($_GET['id'])) {
    $id = (int)$_GET['id'];
    $req =$conn->prepare("SELECT * FROM details_voitures JOIN voitures ON voitures.id = details_voitures.id WHERE id = :id");
    ...
    if(isset($_POST['Update'])){
        ...
        if(isset($caracteristique) && isset($liste_equipements)
            ...
            image1 = :image1, image2 = :image2, image3 = :image3 WHERE id = :id");
            ...
            $req->bindValue(':id', $id_details, PDO::PARAM_INT);
