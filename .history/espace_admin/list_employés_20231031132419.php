...
<section>
   ...
   <div class="content_employés">
      ...
      <p class="titre_empl" style="font-family: 1;">Employés</p>
    </div>
    <div class="content_btn">
       <a href="admin_page.php" class="btn btn-primary back">Back <i class="bi bi-backspace"></i></a>
       <a href="registre.php" class="btn btn-primary" >Ajouter Employé  <i class="fa-solid fa-plus" style="color: #ffffff;"></i></a>
    </div> 
    </div>
