...
if(isset($_POST["action"])) {
    ...
    if(isset($_POST["minimum_price"], $_POST["maximum_price"]) && !empty($_POST["minimum_price"]) && !empty($_POST["maximum_price"])) {
      ...
      if(isset($_POST["minimum_kilom"], $_POST["maximum_kilom"]) && !empty($_POST["minimum_kilom"]) && !empty($_POST["maximum_kilom"])) {
        $query = $conn->query("SELECT * FROM voitures WHERE kilométrage BETWEEN '" . $_POST["minimum_kilom"] . "' AND '" . $_POST["maximum_kilom"] . "'");
      }
      if(isset($_POST["minimum_price"], $_POST["maximum_price"]) && !empty($_POST["minimum_price"]) && !empty($_POST["maximum_price"])) {
        $query = $conn->query("SELECT * FROM voitures WHERE année BETWEEN '" . $_POST["minimum_price"] . "' AND '" . $_POST["maximum_price"] . "'");
      }
