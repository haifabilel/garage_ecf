...
$id =(int)$_GET['id'];
    $record = $conn->prepare('SELECT * FROM services WHERE id = :id');
     ...
     $recupService->bindValue(":id", $id, PDO::PARAM_INT);
    //  $recupService->execute();
     $data = $recupService->fetch($record);
?>
...
<section>
 ...
 <div class="form-group">
     <input type="text" name="titre" value="<?php $data['titre'] ?>" class="form-control"  placeholder="Titre de service" required><br>
 </div>
 <div class="form-group">
