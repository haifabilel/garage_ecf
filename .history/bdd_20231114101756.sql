...
--CREATE TABLE `visiteur` (`id` INT NOT NULL AUTO_INCREMENT , `nom` VARCHAR NOT NULL , `prenom` VARCHAR NOT NULL , `adresse_mail` VARCHAR NOT NULL , `portable` INT NOT NULL , `message` TEXT NOT NULL , PRIMARY KEY (`id`))