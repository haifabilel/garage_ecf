...
<section id="Contact" class="Contact pt-5">
    ...
    <form action="traitement_contact.php" method="POST">
       ...
       <?php
        ...
        <button type="submit" name="submit"  value="je vous contacte concernat :<?php echo $user['brand']; ?>" class="btn_button" value="Envoyer" class="form-btn">Envoyer</button>
    </form>
</div>
<a href="vehicules.php" class="btn-buton">Retourner aux annonces <i class="fa-solid fa-arrow-left-long" style="color: #ffffff;"></i></a>
  </section>
