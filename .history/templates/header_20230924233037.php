  ...
  <div class="container col-xxl-8 px-2 py-6">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <button  type="button" class="btn btn-warning " data-bs-toggle="modal" data-bs-target="#confirmDon" >Contact  <i class="fa-solid fa-message"></i></button>
        </div>
        
<!-- Modal -->
<div class="modal fade" id="buttonModal" tabindex="-1" role="dialog" data-bs-toggle="collapse aria-labelledby="buttonModal" aria-hidden="true">
