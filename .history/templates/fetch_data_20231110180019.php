...
elseif(isset($_POST["minimum_prix"], $_POST["maximum_prix"]) && !empty($_POST["minimum_prix"]) && !empty($_POST["maximum_prix"])) {
  $query = $conn->query("SELECT * FROM voitures WHERE prix BETWEEN '" . $_POST["minimum_prix"] . "' AND '" . $_POST["maximum_prix"] . "'");
}
elseif(isset($_POST["minimum_kilometrage"], $_POST["maximum_kilometrage"]) && !empty($_POST["minimum_kilometrage"]) && !empty($_POST["maximum_kilometrage"])) {
