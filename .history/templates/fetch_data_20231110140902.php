...
if(isset($_POST["action"])) {
    ...
    if(isset($_POST["minimum_kilome"], $_POST["maximum_kilome"]) && !empty($_POST["minimum_kilome"]) && !empty($_POST["maximum_kilome"]))
 {
  $query .= "
   AND kilométrage BETWEEN '".$_POST["minimum_kilome"]."' AND '".$_POST["maximum_kilome"]."'
  ";
 }
 if(isset($_POST["minimum_price"], $_POST["maximum_price"]) && !empty($_POST["minimum_price"]) && !empty($_POST["maximum_price"]))
 {
  $query .= "
   AND année BETWEEN '".$_POST["minimum_price"]."' AND '".$_POST["maximum_price"]."'
  ";
 }
