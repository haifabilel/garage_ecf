  ...
  <form action="" method="POST" enctype="multipart/form-data">
    <div class="modal-content">
      ...
      <div class="form-group">
         <input type="text" name="brand" class="form-control"  placeholder="Brand de la voiture" required><br>
      </div>
      <div class="form-group">
         <input type="number" name="prix" class="form-control"  placeholder="prix" required><br>
      </div>
      <div class="form-group">
         <input type="number" name="kilométrage" class="form-control"  placeholder="Brand" required><br>
      </div>
      <div class="form-group">
         <input type="number" name="année" class="form-control"  placeholder="Brand" required><br>
      </div>
