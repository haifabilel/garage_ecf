...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner1">
    <div class="carousel-item active">
      <img class="d-block w-100" src="./uploads/istockphoto-1589417945-612x612.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./uploads//bmw-m4.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="./uploads//bmw_1.jpg" alt="Third slide">
    </div>
  </div>
