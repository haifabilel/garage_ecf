  ...
  <div class="container_services p-3 ">
    <div class="content_services d-flex">
       ...
       <div class="content_button mt-2">
          <button class="btn btn-primary mx" data-bs-toggle="modal" data-bs-target="#ServiceAdmin">Ajouter services <i class="fa-solid fa-circle-plus" style="color: #ffffff;"></i> </button>
