    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <h4 class="text-center mt-2 mb-4">
            <i class="fa-regular fa-star" submit id="submit_star_1" data-rating="1"></i>
            <i class="fa-regular fa-star" submit id="submit_star_2" data-rating="2"></i>
            <i class="fa-regular fa-star" submit id="submit_star_3" data-rating="3"></i>
            <i class="fa-regular fa-star" submit id="submit_star_4" data-rating="4"></i>
            <i class="fa-regular fa-star" submit id="submit_star_5" data-rating="5"></i>
       </h4>
