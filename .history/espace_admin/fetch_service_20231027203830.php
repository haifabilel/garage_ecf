  ...
  <form action="" method="POST" enctype="multipart/form-data">
    <div class="modal-content">
      ...
      <div class="form-group">
       ...
       <input type="text" value="<?php if(isset($_GET['titre'])) echo($_GET['titre']); ?>" name="titre" class="form-control"  placeholder="Titre de service" required><br>
      </div>
      <div class="form-group">
    <textarea class="form-control" value="<?php if(isset($_GET['description'])) echo($_GET['description']); ?>" name="description" placeholder="Description..."required></textarea><br>
  </div>
