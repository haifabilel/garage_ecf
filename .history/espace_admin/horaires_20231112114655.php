  ...
  <form  method="POST" enctype="multipart/form-data">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title fs-5" id="exampleModalToggleLabel">Update </h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      <div class="form-group">
       <input type="text" name="ouverture_matin" class="form-control"  placeholder="Titre de service" required><br>
      </div>

      <div class="form-group">
       <input type="text" name="fermeture_matin" class="form-control"  placeholder="Titre de service" required><br>
      </div>
      <div class="form-group">
       <input type="text" name="ouverture_apres_midi" class="form-control"  placeholder="Titre de service" required><br>
      </div>
      <div class="form-group">
       <input type="text" name="fermeture_apres_midi" class="form-control"  placeholder="Titre de service" required><br>
      </div>
