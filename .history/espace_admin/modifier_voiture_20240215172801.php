...
if(isset($_POST['Update'])){
  ...
  extract($_POST);
  if(isset($brand) && isset($kilometrage) && isset($prix)&& isset($annee)&& isset($image)){
    //Modifier informations des la voiture
    $req =$conn->query("UPDATE voitures SET brand = '$brand' , kilometrage = '$kilometrage',
     prix = '$prix', annee = '$annee', image = '$img_des' WHERE id = $id ");
    if($req){
