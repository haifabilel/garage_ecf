   ...
   <div class="row">
        <div class="col-md-6 d-flex align-items-center">
          ...
          <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-body-secondary" href="#"><i class="fa-brands fa-github" style="color: #ffffff;"></i></a></li>
            <li class="ms-3"><a class="text-body-secondary" href="#"><i class="fa-brands fa-twitter" style="color: #fafdff;"></i></a></li>
            <li class="ms-3"><a class="text-body-secondary" href="#"><i class="fa-brands fa-instagram" style="color: #ffffff;"></i></a></li>
