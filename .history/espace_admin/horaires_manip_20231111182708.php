    ...
    <form method="post">
        ...
        <select name="jour" id="jour">
            <?php foreach ($horaires as $horaire): ?>
                ...
                <option value="<?= $horaire['ouverture_matin'] ?>"><?= $horaire['ouverture_matin'] ?></option>
                <option value="<?= $horaire['fermeture_matin'] ?>"><?= $horaire['fermeture_matin'] ?></option>
                <option value="<?= $horaire['ouverture_apres_midi'] ?>"><?= $horaire['ouverture_apres_midi'] ?></option>
                <option value="<?= $horaire['fermeture_apres_midi'] ?>"><?= $horaire['fermeture_apres_midi'] ?></option>
            <?php endforeach; ?>
        </select>
