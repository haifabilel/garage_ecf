...
// Verfier le format de l'email
    if(empty(htmlspecialchars($_POST['email'])) || !filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
...
//Verfier si le password est le meme password confirm
    if(empty(htmlspecialchars($_POST['password'])) || htmlspecialchars$_POST['password'] != $_POST['cpassword']){
