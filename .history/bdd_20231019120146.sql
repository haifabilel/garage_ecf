...
CREATE TABLE `ecf`.`review_table` (`review_id` INT NOT NULL AUTO_INCREMENT , `user_name` VARCHAR(50) NOT NULL , `user_rating` VARCHAR(5) NOT NULL , `user_review` VARCHAR(255) NOT NULL , `datetime` DATETIME NOT NULL , PRIMARY KEY (`review_id`)) ENGINE = MyISAM;