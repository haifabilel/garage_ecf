...
<section>
	  ...
	  <h3 class="titre_reviews">Votre avis nous interesse</h3>
...
<a href="../index.php" class="btn btn-primary back_reviews mt-6">Back <i class="fa-solid fa-arrow-left-long" style="color: #ffffff;"></i></a>
