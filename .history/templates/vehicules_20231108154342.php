...
require_once 'head.php';
  ...
  <div class="row">
   ...
   if(isset($_POST["action"]))
   {
    ...
    {
        $query = $conn->prepare("SELECT * FROM voitures WHERE prix BETWEEN '".$_POST["minimum_price"]."' AND '".$_POST["maximum_price"]."'");
    }
    ...
    ?>
         ...
         <div class="card-body">
          ...
          <a href="details_car.?id=<?=$user['id']?>" type="submit" class="btn btn-primary mx-2">Détails</a>
          <?php
          }
        }else{
