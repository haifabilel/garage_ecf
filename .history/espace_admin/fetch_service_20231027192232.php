...
<tbody>
    ...
    <?php
     ...
     while($user = $req->fetch()){
        ...
        <td>
        <a class="btn btn-primary" href="id=<?=$user['id']?>"><i class="fa-regular fa-pen-to-square" style="color: #ffffff;"></i></a><br><br>
        <a class="btn btn-primary" href="supprimer_service.php?id=<?=$user['id']?>"
        data-bs-toggle="modal" data-bs-target="#ServiceUpdate"><i class="fa-regular fa-trash-can"></i></a>
        </td>
        </tr>
