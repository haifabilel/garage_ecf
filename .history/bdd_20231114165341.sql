...
--INSERT INTO `review_table` (`review_id`, `user_name`, `user_rating`, `user_review`, `datetime`) VALUES (16, 'Adam', 5, 'trés bon équipe', 1698053268),
(17, 'Christophe', 4, 'Prix correcte', 1698053302),
(15, 'Jean CHARLES', 5, 'bravo pour le service!', 1697830115),
(22, 'Christine', 1, 'je recommande pas', 1698348131),
(21, 'Jack', 1, 'je recommande pas ce garage', 1698070181);
