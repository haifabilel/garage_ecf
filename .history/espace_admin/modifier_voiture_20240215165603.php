        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <input type="text" name="brand" class="form-control" placeholder="Caractéristique" required><br>
                </div>
                <div class="form-group">
                    <input type="text" name="prix" class="form-control" placeholder="Liste des équipements" required><br>
                </div>
                <div class="form-group">
                    <input type="text" name="kilometrage" class="form-control" placeholder="Options installés" required><br>
                </div>
                <div class="form-group mb-3">
                    <input type="file" name="annee" class="form-control">
                </div>
                <div class="form-group mb-3">
