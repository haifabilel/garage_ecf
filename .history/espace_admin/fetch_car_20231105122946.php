...
<div class="container_services p-3 ">
    <div class="content_services d-flex">
       ...
       <div class="content_button mt-2">
          <button class="btn btn-primary mx-2" ircle-plus" style="color: #ffffff;"></i> </button>
          <a href="espace_employé.php" class="btn btn-primary">Back  <i class="bi bi-backspace"></i></a>data-bs-toggle="modal" data-bs-target="#ajoutCar">Ajouter Véhicule <i class="fa-solid fa-c
       </div>
    </div>
