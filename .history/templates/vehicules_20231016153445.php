...
<div class="kilométrage">
    ...
    <div class="field">
        <span>Min</span>
        <input type="number" class="input_min" value="1500">
    </div>
    <br>
    <div class="field">
        <span>Max</span>
        <input type="number" class="input_max" value="150000">
    </div>
    <br>
    <div class="slider">
        <div class="progress"></div>
    ...
    <div class="range_input">
       <p id="price_show">1000 - 65000</p>
        <input type="range" class="range_min" min="0" max="10000" value="1500">
        <input type="range" class="range_max" min="0" max="10000" value="150000">
    </div>
    </div>
    <br>
   </div>
