...
<tbody>
    ...
    <?php
     ...
     while($user = $req->fetch()){
        ?>
        <tr>
        <td class="td_image"><img src="../uploads/<?php echo $user['image']; ?>"src="../uploads/<?php echo $user['image']; ?>"src="../uploads/<?php echo $user['image']; ?>" alt="image_car" class="image_car" ></td>
        <td><?=$user['brand']?></td>
        <td><?=$user['prix']?></td>
