...
if(isset($_POST["action"])) {
    ...
    {
     $query .= "
      AND kilométrage BETWEEN '".$_POST["minimum_kilometrage"]."' AND '".$_POST["maximum_kilometrage"]."'
     ";
    }
    if(isset($_POST["minimum_anné"], $_POST["maximum_anné"]) && !empty($_POST["minimum_anné"]) && !empty($_POST["maximum_anné"]))
    {
     $query .= "
      AND année BETWEEN '".$_POST["minimum_anné"]."' AND '".$_POST["maximum_anné"]."'
     ";
    }
