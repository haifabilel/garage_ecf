...
<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <?php 
  $id = (int)$_GET['id'];
  $req = $conn->query("SELECT *, details_voitures.id as id_details FROM details_voitures JOIN voitures ON voitures.id = details_voitures.id_details WHERE voitures.id = $id");
  $user = $req->fetch();
...
<div class="table_car">
  <table class="blueTable table-responsive">
    ...
    <tbody>
        ...
        <td>
           <a href="update_det.php?id=<?=$user['id']?>" class="btn btn-primary">Update</a>
        </td>
        </tr>
