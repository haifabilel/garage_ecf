...
--CREATE TABLE IF NOT EXISTS `review_table` (`review_id` int NOT NULL AUTO_INCREMENT,user_name` varchar(50) NOT NULL,user_rating` int NOT NULL,user_review` text CHARACTER NOT NULL);
  --`datetime` int NOT NULL, PRIMARY KEY (`review_id`)
