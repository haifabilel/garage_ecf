   ...
   <section id="Contact" class="Contact pt-5">
    ...
    <form method="POST">
       <h3>Formulaire de contact</h3>
        ...
        <input type="email" name="email" required placeholder="entrer votre email"required>
        <input type="" name="password" required placeholder="entrer votre numéro portable"required>
