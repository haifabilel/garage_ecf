...
if(isset($_POST["action"])) {
    ...
    if(isset($_POST["minimum_price"] AND $_POST["maximum_price"] AND $_POST["minimum_kilometrage"] AND $_POST["maximum_kilometrage"] AND
    $_POST["minimum_année"] AND $_POST["maximum_année"]) 
