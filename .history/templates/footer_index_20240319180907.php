<footer class="footer_index d-flex flex-wrap justify-content-around align-items-center border-top">
    <div class="contact-info col-md-5 d-flex align-items-center">
        <div class="contact-infos">
            ...
            <a href="./templates/contact.php" type="button" class="btn btn-primary" id="btn_index">contact</a>
        </div> 
    </div>
    <div class="reviews-section col-md-4">
        <h5>SATISFAIT DE NOS SERVICES ?</h5>
        <a href="./templates/reviews.php" type="button" class="btn btn-primary" id="btn_index">Ajouter un avis</a>
    </div>
