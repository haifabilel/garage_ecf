...
if(isset($_POST['addDétails'])){
  ...
  $image = $_FILES['image'];
  $img_loc = $_FILES['image1']['tmp_name'];
  $img_name = $_FILES['image1']['name'];

  $img_loc = $_FILES['image2']['tmp_name'];
  $img_name = $_FILES['image2']['name'];

  $img_loc = $_FILES['image3']['tmp_name'];
  $img_name = $_FILES['image3']['name'];

  $img_loc = $_FILES['image4']['tmp_name'];
  ...
  $query = "INSERT INTO details_voitures (caractéristique, liste_équipements, options_installés, image)
   VALUES ('$caractéristique','$liste_équipements','$options_installés','$img_des')";
