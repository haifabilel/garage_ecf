...
<a  href="#"><i class="fa-brands fa-github" style="color: #ffffff;"></i></a></li>
<a  href="#"><i class="fa-brands fa-twitter" style="color: #fafdff;"></i></a></li>
<a  href="#"><i class="fa-brands fa-instagram" style="color: #ffffff;"></i></a></li>
<a  href="#"><i class="fa-brands fa-facebook" style="color: #ffffff;"></i></a></li>
</ul>
</div>
</div>
