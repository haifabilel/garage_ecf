...
--CREATE TABLE IF NOT EXISTS `review_table` (`review_id` int NOT NULL AUTO_INCREMENT,user_name` varchar(50) NOT NULL,user_rating` int NOT NULL,user_review` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
