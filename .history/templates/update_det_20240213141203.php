...
if(isset($_GET['id_details'])) {
    ...
    if(isset($_POST['Update'])){
        ...
        if(isset($details_voitures) && isset($caracteristique) && isset($liste_equipements)
            ...
            // Utilisation d'une requête préparée pour sécuriser contre les injections SQL
            ...
            $req->bindValue(':image1', $image1, PDO::PARAM_STR);
            $req->bindValue(':image2', $image2, PDO::PARAM_STR);
            $req->bindValue(':image3', $image3, PDO::PARAM_STR);
            $req->bindValue(':id_details', $id_details, PDO::PARAM_INT);
