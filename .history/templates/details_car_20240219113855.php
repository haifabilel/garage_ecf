...
<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <?php 
  $id =(int)$_GET['id'];
  $req =$conn->query("SELECT * FROM details_voitures JOIN voitures ON voitures.id = details_voitures.id WHERE id = $id");
  $user= $req-> fetch();
     ?>
...
<div class="table_car">
  <table class="blueTable table-responsive">
    ...
    <tbody>
        ...
        <td>
           <a href="update_det.php?id=<?=$user['id_details']?>" class="btn btn-primary">Update</a>
        </td>
        </tr>
