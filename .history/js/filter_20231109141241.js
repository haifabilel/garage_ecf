...
$(document).ready(function(){
    ...
    function filter_data()
    {
        ...
        $.ajax({
            url:"vehicules.php",
            method:"POST",
            data:{action:action, minimum_price:minimum_price,minimum_kilométrage:minimum_
                data:{action:action, minimum_price:minimum_price,minimum_kilométrage,minimum_price:minimum_price, maximum_price:maximum_price},
