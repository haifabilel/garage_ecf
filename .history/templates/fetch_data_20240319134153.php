...
?>
            <div class="col-lg-4 d-flex">
                <div class="card_car">
                    ...
                    <div class="card-body">
                        <p class="card-text1"><spanPrix: <?php echo $user['prix']; ?></p>
                        <p class="card-text1"><spankilométrage: <?php echo $user['kilometrage']; ?></p>
                        <p class="card-text1"><spanAnnée: <?php echo $user['annee']; ?></p>
                    </div>
