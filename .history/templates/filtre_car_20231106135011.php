...
<body>
<div class="container_fil" style=" width:100%;background-color:grey;" >
    <div class="row filter_row" >
        <div class="col-md-3 filtre_col" style="margin-left:35%;justify-content:space-between;gap:70px;">                                
            <div class="list-group" style="" >
                <h3 style="color: white;">Prix</h3>
                ...
                <div id="price_range" style="width:150px;"></div>
            </div>  
