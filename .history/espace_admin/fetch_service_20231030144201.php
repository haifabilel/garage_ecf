...
<tbody>
    ...
    <?php
     ...
     while($user = $req->fetch()){
        ...
        <td>
        <a  class="btn btn-primary"href="id=<?=$user['id']?>"data-bs-toggle="modal" data-bs-target="#ServiceAdmin"><i class="fa-regular fa-pen-to-square" style="color: #ffffff;"></i></a><br><br>
