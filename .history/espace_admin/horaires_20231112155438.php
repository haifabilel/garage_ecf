    ...
    <?php
     ...
     while($user = $req->fetch()){
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-primary" href="update_horaires.php?id=<?=$user['id']?>" id="update_horaires">Update <i class="fa-regular fa-pen-to-square" style="color: #ffffff;"></i></a><br><br>
            </td>
        </tr>
        <?php 
     }
