...
if(isset($_POST['Update'])){
  ...
  if(isset($titre) && isset($description) && isset($image)){
    ...
    $req =$conn->query("UPDATE details_voitures SET caracteristique = '$caracteristique' , liste_equipements = '$liste_equipements',options_installes = '$options_installes' ,image = '$image' WHERE id = $id ");
    if($req){
