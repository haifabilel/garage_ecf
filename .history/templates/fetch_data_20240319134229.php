...
?>
            <div class="col-lg-4 d-flex">
                <div class="card_car">
                    ...
                    <div class="card-body">
                        <p class="card-text1"><span class>Prix:</span> <?php echo $user['prix']; ?></p>
                        <p class="card-text1"><span class>kilométrage:</span> <?php echo $user['kilometrage']; ?></p>
                        <p class="card-text1"><span class>Année:</span> <?php echo $user['annee']; ?></p>
                    </div>
