...
$(document).ready(function(){
    ...
    function filter_data()
    {
        ...
        var minimum_kilométrage = $('#hidden_minimum_kilométrage').val();
        var maximum_kilométrage = $('#hidden_maximum_kilométrage').val();
        ...
        $.ajax({
            ...
            data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price
                ...
                minimum_année:minimum_année,maximum_price:maximum_price,maximum_kilometrage:maximum_kilometrage,
                maximum_année:maximum_année                ,minimum_kilometrage:minimum_kilometrage,},
