...
<div class="container_header p-3 ">
    ...
    <div class="content_button mt-2">
        ...
        <a href="vehicules.php" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#updatDétails">Update détails <i class=<i class="fa-regular fa-pen-to-square"></i></a>
    </div>
</div>
