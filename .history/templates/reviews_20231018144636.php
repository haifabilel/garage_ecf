            ...
            <div class="card_body">
                <div class="row">
                    <div class="col-sm-4 text-center">
                        ...
                        <div class="mb-3">
                            <i class="fas fa-star  mr-1 main-star"></i>
                    ...
                    <div class="col-sm-4 text-center">
                       ...
                       <button type="button" name="add_review" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#review">Ajouter Avis</button>
                    </div>
                </div>
            </div>
        </div>
...
<!------------------------- Modal -------------------------->
 <div class="modal fade" id="buttonModal" tabindex="-1" role="dialog" aria-labelledby="review" aria-hidden="true">
